...
const Output = () => {
    ...
    return (
        <div className="border-3 transform hover:scale-101 transition-transform duration-200 p-2 w-230 h-180 m-5 mr-20 flex flex-col  space-y-8 font-proj justify-center">
            ...
            <div className="border-3 border-gray-400 w-190 mx-10 mb-5 h-full ">
