...
const Output = () => {
    ...
    return (
        <div className="border-4 border-gray-600 transform hover:scale-101 transition-transform duration-200 p-2 w-230 h-180 m-5 mr-20 mt-6 flex flex-col  space-y-8 font-proj justify-center">
