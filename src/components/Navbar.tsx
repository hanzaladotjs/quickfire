...
const Navbar = () => {
    ...
    return (
        <div className={theme ? " flex  px-15 justify-between  h-18 items-center  border-b-[4px]" : " flex  px-15 justify-between  h-18 items-center border-emerald-200 border-b-[4px]" }>
