...
const Navbar = () => {
    ...
    return (
        <div className={theme ? "  flex  px-15 justify-between  h-18 items-center  border-gray-600 border-b-[4px]" : " flex  px-15 justify-between  h-18 items-center border-gray-600 border-b-[4px] " }>
            <div className=" space-x-2 flex items-center ">
                <div className= { theme ? "border-3  bg-black w-12 h-12 flex justify-center items-center transform hover:scale-105 transition-transform duration-200" :  "border-3 border-stone-700  bg-emerald-400 w-12 h-12 flex justify-center items-center transform hover:scale-105 transition-transform duration-100"}>
            ...
            <div className={theme ? "bg-black b w-13 h-12 flex justify-center border-3 items-center transform hover:scale-105 transition-transform duration-100 " : "bg-emerald-400 b w-13 h-12 flex justify-center border-3  border-stone-700 items-center transform hover:scale-105 transition-transform duration-100 " }>
