...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      className={cn(
        "relative flex cursor-default select-none items-center   gap-2 py-1.5 pl-8 pr-2 text-sm font-base outline-hidden transition-colors  data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
      {...props}
    >
