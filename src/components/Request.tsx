...
const Request = () => {
    ...
    return (
        ...
        <div className="border-3 py-2 w-170 ml-25 mt-5 transform hover:scale-105 transition-transform duration-200">
            ...
            <button className="bg-gray-700 text-gray-400 py-4 my-3 mx-10 w-150 transform hover:scale-105 transition-transform duration-100 flex space-x-2 justify-center items-center">
